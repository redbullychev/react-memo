...
При выборе **легкого режима** появляется счетчик жизней равный 3. Каждая жизнь это права на одну ошибку.

### Суперсила “Алохомора”
 Открывается случайная пара карт. Может быть использована только один раз за игру.

 ### Лидерборд
 Показывает на странице результаты игроков, упорядоченные по возрастанию времени.
